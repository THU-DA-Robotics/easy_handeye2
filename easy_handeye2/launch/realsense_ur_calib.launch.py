...
def generate_launch_description():
    aruco_single_params = {
        ...
        "marker_id": 99,
        "marker_size": 0.15,
        "reference_frame": "camera_link", # change to your camera frame
        "camera_frame": "camera_color_frame",
        "marker_frame": "camera_marker",
        "corner_refinement": "LINES",
    }
    aruco_camera_info_topic_name = "/camera/camera/color/camera_info"
    aruco_image_topic_name = "/camera/camera/color/image_raw"
